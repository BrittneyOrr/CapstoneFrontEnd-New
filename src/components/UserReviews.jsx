                            ...
                            <div key={userId} className="col">
                                <div className="card h-100" style={{ backgroundColor: '#333', color: 'white' }}>
                                    <div className="card-body">
                                        <p className="card-text"><strong style={{ color: 'yellow' }}>Rating:</strong> {rating}</p>
                                        <p className="card-text"><strong style={{ color: 'orange' }}>Review:</strong> {comment}</p>
                                        <p className="card-text"><strong style={{ color: 'green' }}>Review Date:</strong> {review_date}</p>
                                    </div>
